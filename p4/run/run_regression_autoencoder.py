#!/usr/bin/env python3
"""Peter Rasmussen, Programming Assignment 4, run_regression_autoencoder.py
...
def run_regression_autoencoder(
        src_dir: Path,
        dst_dir: Path,
        k_folds: int,
        val_frac: float
    ...
    """
    Train and score an MLP with autoencoder on three regression datasets.
