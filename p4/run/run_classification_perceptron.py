#!/usr/bin/env python3
"""Peter Rasmussen, Programming Assignment 4, run_classification_perceptron.py
"""
...
from p4.perceptrons.regression_perceptron import predict
from p4.utils import cross_entropy, dummy_categorical_label, accuracy
...
from p4.perceptrons.classification_perceptron import gradient, predict
...
def run_classification_perceptron(
        src_dir: Path,
        dst_dir: Path,
        k_folds: int,
        val_frac: float
    ...
    """
    Train and score perceptron on three classification datasets.
    :param src_dir: Input data directory
    :param dst_dir: Output data directory
    :param k_folds: Number of cross-validation folds
    :param val_frac: Fraction of samples to be used for validation
    """
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
